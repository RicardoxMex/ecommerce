<x-app-layout>
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="grid-cols-1">
                <h1 class="font-bold text-xl text-trueGray-700">{{$product->name}}</h1>
                <div class="flex">
                    ...
                    <a class="text-orange-500 underline cursor-pointer hover:text-orange-600">39 reseñas</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">Se hace envios a todo Mexico</p>
