        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            <ul>
                ...
                <li class=" text-trueGray-500 hover:bg-orange-500 hover:text-white">
                    <a href="" class="py-2 px-4 text-lg flex items-center">
                        <span class="flex justify-center w-9">{!! $category->icon !!}</span>
                        {{ $category->name }}
                    </a>
                </li>
            ...
            <div>
                <a href="" class="py-2 px-4 text-lg flex items-center text-trueGray-500 hover:bg-orange-500 hover:text-white">
            ...
            @auth
            <a href="{{route('profile.show')}}" class="py-2 px-4 text-lg flex items-center text-trueGray-500 hover:bg-orange-500 hover:text-white">
                <span class="flex justify-center w-9">
                    <li class="far fa-address-card"></li>
                </span>
                Perfil
            </a>
            <a
            ...
            href="" class="py-2 px-4 text-lg flex items-center text-trueGray-500 hover:bg-orange-500 hover:text-white">
                <span class="flex justify-center w-9">
            ...
            @else
            <a href="{{route('login')}}" class="py-2 px-4 text-lg flex items-center text-trueGray-500 hover:bg-orange-500 hover:text-white">
                <span class="flex justify-center w-9">
                    <li class="fas fa-user-circle"></li>
                </span>
                Iniciar Sesion
            </a>
            <a href="{{route('register')}}" class="py-2 px-4 text-lg flex items-center text-trueGray-500 hover:bg-orange-500 hover:text-white">
                <span class="flex justify-center w-9">
                    <li class="fas fa-fingerprint"></li>
                </span>
                Registrate
            </a>
            @endauth
